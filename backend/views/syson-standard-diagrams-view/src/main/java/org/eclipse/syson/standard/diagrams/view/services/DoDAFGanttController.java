...
public class DoDAFGanttController {
    ...
    @PostMapping("/api/matrix/{repId}/relations") public Map<String,Object> createRelation(@PathVariable String repId, @RequestBody Map<String,Object> r) { return s.createRelation((String)r.get("sourceId"),(String)r.get("targetId"),(String)r.get("relationType"),(String)r.get("siriusId")); }
